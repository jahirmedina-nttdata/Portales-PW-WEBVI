package org.medioAmbiente.CAP_F_016A.page;
...
public class CAP_F_016APage extends PageObject {
    ...
    @FindBy(xpath = "//*[@id=\"_AssetSearchPlugin_INSTANCE_TqROmJRS1xw7_searchTextInput\"]")
    private WebElementFacade txtFieldBuscador;

    @FindBy(xpath = "//*[@id=\"_AssetSearchPlugin_INSTANCE_TqROmJRS1xw7_startDate\"]")
    private WebElementFacade txtDesdeFecha;

    @FindBy(xpath = "//*[@id=\"_AssetSearchPlugin_INSTANCE_TqROmJRS1xw7_endDate\"]")
