package org.medioAmbiente.CAP_F_087.page;
...
@DefaultUrl("https://servintegra.cma.junta-andalucia.es/medioambiente/portal/web/ventanadelvisitante/noticias")


public class CAP_F_087Page extends PageObject {
    ...
    @FindBy(xpath = "//button[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_searchButton\"]")
    private WebElementFacade btnBuscar;

    @FindBy(xpath = "//input[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_searchTextInput\"][@title=\"Buscar\"]")
    private WebElementFacade txtBusquedaPorPalabra;

    @FindBy(xpath = "//span[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_category0-button\"]")
    private WebElementFacade dropDownMenuProvincias;

    @FindAll(@FindBy(xpath = "//ul[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_category0-menu\"]//li[@class='ui-menu-item']//div"))
    private List<WebElementFacade> dropDownElementsProvincias;
    //*
    @FindBy(xpath = "//span[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_category1-button\"]")
    private WebElementFacade dropDownMenuEspaciosNaturales;

    @FindAll(@FindBy(xpath = "//ul[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_category1-menu\"]//li[@class='ui-menu-item']//div"))
    private List<WebElementFacade> dropDownElementsEspaciosNaturales;

    @FindBy(xpath = "//div[@class=\"form-group input-select-wrapper\"]//span[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_espaciosNaturales-button\"]")
    private WebElementFacade dropDownMenuNombreEspacioNatural;
    //*
    @FindAll(@FindBy(xpath = "//div[@class=\"ui-selectmenu-menu ui-front ui-selectmenu-open\"]//ul[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_espaciosNaturales-menu\"]//li//div"))
    private List<WebElementFacade> dropDownElementsNombreEspacioNatural;

    @FindBy(xpath = "//span[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_category2-button\"]")
    private WebElementFacade dropDownMenuTipoEquipamento;

    @FindAll(@FindBy(xpath = "//ul[@id=\"_AssetSearchPlugin_INSTANCE_agurN6e4v7Bv_category2-menu\"]//li//div[@role=\"option\"]"))
