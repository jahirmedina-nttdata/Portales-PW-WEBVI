package org.medioAmbiente.CAP_F_009.page;
...
public class CAP_F_009Page extends PageObject {
    ...
    @FindBy(xpath = "//div[@class=\" portlet-content-container\"]//div//button[@class=\"evr-btn--add-fav\"]")
    private WebElementFacade btnFavoritesAdd;

    @FindBy(xpath = "//div[@class=\" portlet-content-container\"]//div//button[@class=\"evr-btn--delete-fav\"]")
    private WebElementFacade btnFavoritesDelete;
    ...
    public void clickAgregarFavoritos() throws InterruptedException {
        btnFavoritesAdd.waitUntilClickable();
        btnFavoritesAdd.click();
    }

    public void clickEliminarFavoritos() throws InterruptedException {
        btnFavoritesDelete.waitUntilClickable();
        btnFavoritesDelete.click();
    }
}
